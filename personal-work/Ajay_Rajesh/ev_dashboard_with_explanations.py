...
fig1, ax1 = plt.subplots(figsize=(6, 3))  # width=6, height=3
...
fig2, ax2 = plt.subplots(figsize=(3, 3))  # width=6, height=3
...
fig3, ax3 = plt.subplots(figsize=(6, 3))  # width=6, height=3
